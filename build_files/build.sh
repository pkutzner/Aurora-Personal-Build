...
dnf5 install -y tmux aria2.x86_64 kernel-devel kernel-headers gcc make patch wget git
...
/tmp/VMware-Workstation-Full-17.6.4-24832109.x86_64.bundle --eulas-agreed --console --required -I
